...
inner_diameter = 3.0
flow_rate = 66000.0
dt = 0.05    #NOTE: sometimes you need to increase dt for convergence
...
[Kernels]
    ...
    [./NO2_Ag_aging]
        ...
        gases_stoichiometry = ''
        gas_order = ''
        coupled_catalysts = 'NO2'
        catalyst_stoichiometry = '2'
        catalyst_order = '2'
        coupled_adsorption = 'I2_Adsorbed Deactivated_Ag'
        adsorbed_sites = '2 1'
        site_order = '2 3'
        ...
        ads_order = '2 3'
        max_capacity = 1.1102
        forward_rate = 15476864.87
        reverse_rate = 289220.51
    [../]
...
[Materials]
    ...
    [./FlowMaterials]
        ...
        block = 0
        molecular_weight = '28.016 32 46.0 253.8'
        comp_heat_capacity = '1.04 0.919 0.8066 0.214'
        comp_ref_viscosity = '0.0001781 0.0002018 0.00001963 0.00013283'
        comp_ref_temp = '300.55 292.25 400.0 295.496'
        comp_Sutherland_const = '111 127 701.226 573.474'
        temperature = column_temp
    ...
    [./AdsorbateMaterials]
        ...
        molar_volume = '0 0 13500.0 41.8' #cm^3/mol
        enthalpy_site_1 = '0 0 0 -8308'
