...
[BCs]
	...
	[./Kr_Flux]
		...
		input_molefraction = 0.000115325
		index = 0
	[../]
	...
	[./Xe_Flux]
		...
		input_temperature = 220.15
		input_pressure = 101.35
		input_molefraction = 0.000755271
		index = 1
	[../]
	...
	[./N2_Flux]
		...
		input_temperature = 220.15
		input_pressure = 101.35
		input_molefraction = 0.5914  #3.27e-2 mol/L
		index = 2
	[../]
...
[Materials]
	...
	[./BedMaterials]
		...
		block = 0
outer_diameter = 1.27
bulk_porosity = 0.697				#bulk density ~0.35
		wall_density = 7.7
