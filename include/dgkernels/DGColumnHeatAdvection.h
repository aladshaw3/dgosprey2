 ...
 *	\details This file creates a discontinous Galerkin kernel for the advective heat transfer in a fixed-bed column.
 *			The advection portion of the energy transport equations involves the linear velocity in the system, as 
 *			well as the gas density and gas heat capacity. Those parameters are given as material properties for the
 *			system.
 *
