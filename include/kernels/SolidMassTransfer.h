...
/// SolidMassTransfer class object forward declarationss
class SolidMassTransfer;

template<>
InputParameters validParams<SolidMassTransfer>();

/// SolidMassTransfer class object inherits from Kernel object
...
class SolidMassTransfer : public CoupledCoeffTimeDerivative
{
public:
	/// Required constructor for objects in MOOSE
	SolidMassTransfer(const InputParameters & parameters);
