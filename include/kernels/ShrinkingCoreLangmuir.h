...
/// ShrinkingCoreLangmuir class object inherits from Kernel object
 ...
 */
class ShrinkingCoreLangmuir : public ShrinkingCoreConstant
{
public:
    /// Required constructor for objects in MOOSE
    ShrinkingCoreLangmuir(const InputParameters & parameters);
    
protected:
    /// Function to compute equilibria adsorption as a langmuir function
    void computeLangmuirIsotherm ();
...
private:
    Real _langmuircoef; ///< Coefficient for a langmuir isotherm
    Real _absmaxcap; ///< Maximum adsorption capacity
